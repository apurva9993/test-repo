...
<div id="cpb-other-extensions">
    ...
    if ($extensions) {
        ?>
            ...
            foreach ($extensions as $extension) {
                ...
                echo '<li class="product" title="' . __('Click here to know more', 'custom-product-boxes') . '">';
        ...
        if (0 == $i) {
            ?>
            <h1 class="thank-you"><?php _e('You have all of our extensions. Thank you for your support!', 'custom-product-boxes'); ?></h1>
                <?php
        }
    }
    ?>
    <p>
        ...
        <?php _e('Browse all our extensions', 'custom-product-boxes'); ?>
        </a>
    </p>
</div>
