...
// Get the CPB Product info., and display in the vertical format.
global $product;
...
<!-- <div class = "row" > -->
	...
	<div class="cpb-row cpb-clear">
			...
			*/
			...
			<div id = "wdm_product_bundle_container_form-left" class="wdm_product_bundle_container_form" >
				<form name = "wdmBundleProduct" method="post" enctype="multipart/form-data" id="contactTrigger" class="cpb-row cpb-clear" novalidate >
					<div class="cpb-col-sm-6 cpb-col-md-6 cpb-col-lg-6 cpb-col-xl-6">
						<div id = "wdm-bundle-bundle-box-left" class="wdm-bundle-bundle-box" data-bundle-price = "<?php echo esc_attr( $price ); ?>" data-signup-fee = "<?php echo esc_attr( $signup_fee ); ?>">
						<?php
					...
					<div class="cpb-col-sm-6 cpb-col-md-6 cpb-col-lg-6 cpb-col-xl-6">
						<div id = "wdm-bundle-product-product-group-left" class = "wdm-bundle-product-product-group">
