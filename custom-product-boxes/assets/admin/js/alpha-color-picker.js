...
( function( $ ) {
	...
	$.fn.alphaColorPicker = function() {
		...
		return this.each( function() {
			...
			$container.find( '.button.wp-color-result' ).on( 'click', function() {
				if (jQuery('#wdm_bundle_product_data.woocommerce_options_panel .button.wp-color-result').hasClass('wp-picker-open')) {
					jQuery('#wdm_bundle_product_data.woocommerce_options_panel .alpha-color-picker-wrap .wp-picker-container input[type=text].wp-color-picker').css('pointer-events', 'visible');
				} else {
					jQuery('#wdm_bundle_product_data.woocommerce_options_panel .alpha-color-picker-wrap .wp-picker-container input[type=text].wp-color-picker').css('pointer-events', 'none');
